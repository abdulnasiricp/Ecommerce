            ...
            <div class="page-header">
               <div class="row">
                  ...
                  @if (Session::has('user') && Session::get('user')['role'] === 'admin')
                   <h3 class="page-title">Welcome {{Session::get('user')['name']}}</h3>
                @else 
                              ...
                              <tbody>
                                 <tr>
                                    <td class="text-nowrap">
                                       <img class="avatar-xs rounded-circle" src="assets/img/customer/user-05.jpg"
                                          alt="User Image"> Annette Silva
                                    </td>
                                 ...
                                 <tr>
                                    <td class="text-nowrap">
                                       <img class="avatar-xs rounded-circle" src="assets/img/customer/user-06.jpg"
                                          alt="User Image"> Stephen Wilson
                                    </td>
                                 ...
                                 <tr>
                                    <td class="text-nowrap">
                                       <img class="avatar-xs rounded-circle" src="assets/img/customer/user-07.jpg"
                                          alt="User Image"> Ryan Rodriguez
                                    </td>
                                 ...
                                 <tr>
                                    <td class="text-nowrap">
                                       <img class="avatar-xs rounded-circle" src="assets/img/customer/user-08.jpg"
                                          alt="User Image"> Lucile Devera
                                    </td>
                                 ...
                                 <tr>
                                    <td class="text-nowrap">
                                       <img class="avatar-xs rounded-circle" src="assets/img/customer/user-09.jpg"
                                          alt="User Image"> Roland Storey
                                    </td>
