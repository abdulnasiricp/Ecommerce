            ...
            <div class="sidebar-inner slimscroll">
               <div id="sidebar-menu" class="sidebar-menu">
                  <ul>
                     ...
                     <li>
                        <a href="admin-profile"><i class="fas fa-user-plus"></i> <span>Profile</span></a>
                     </li>
                     <li class="submenu">
                     ...
                     <li>
                        <a href="maps-vector"><i class="far fa-map"></i> <span>Vector Maps</span></a>
                     </li>
                     <li class="menu-title">
                     ...
                     <div class="card provider-widget clearfix">
                        <div class="card-body">
                           ...
                           <div class="provider-info">
                              <p class="mb-1"><i class="far fa-envelope"></i> <a href="#"><span class="__cf_email__" data-cfemail="44302c2b2925372c21363e2621362304213c25293428216a272b29">[email&#160;protected]</span></a></p>
