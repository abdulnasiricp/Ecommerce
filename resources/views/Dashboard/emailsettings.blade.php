                              ...
                              <div class="form-group">
                                 <div class="d-flex">
                                    <div class="form-check me-3">
                                       <input type="radio" class="form-check-input" id="php_mail" name="gateway_type" value="php_mail" checked>
                                       <label class="form-check-label" for="php_mail">PHP Mail</label>
                                    </div>
                                    <div class="form-check">
                                       <input type="radio" class="form-check-input" id="smtp_mail" name="gateway_type" value="php_mail">
